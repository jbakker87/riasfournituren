...
<div class="row-settings-block">
	<div class="settings-block-label col-xs-4 col-sm-3">
		...
		<?php 
		echo esc_attr(__('Set filter title as search input placeholder.', 'woo-product-filter') . ' <a href="' . esc_url('https://' . WPF_WP_PLUGIN_URL . '/documentation/search-by-text-optionswpf/') . '" class="wupsales-wc-hidden" target="_blank">' . __('Learn More', 'woo-product-filter') . '</a>')
		; 
		?>
		"></i>
	</div>
